...
#define IMG_DIR_MAP			R"(.\MY_IMG\Map)"				//マップの画像ファイりの場所
...
#define MY_MAP_TEST2		R"(\test_2.png)"			//テスト用
#define MY_MAP_TEST3		R"(\test_3.png)"			//テスト用
#define MY_MAP_TEST4		R"(\test_4.png)"			//テスト用
